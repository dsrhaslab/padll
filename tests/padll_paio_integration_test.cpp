...
public:
    ...
    {
        std::cout << "\n\n-------------------------------------------------------\n";
        return std::make_shared<paio::PaioStage> (num_channels,
            object_creation,
            stage_name,
            hsk_file,
            dif_file,
...
int main ()
{
    ...
    std::shared_ptr<paio::PaioStage> stage_ptr = test.initialize (num_channels,
    ...
    std::unique_ptr<paio::PaioInstance> instance_ptr
        = std::make_unique<paio::PaioInstance> (stage_ptr);
