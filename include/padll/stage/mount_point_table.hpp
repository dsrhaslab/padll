...
public:
    ...
    /**
     * pick_workflow_id:
     * FIXME: this method is a temporary hack to overcome the limitation of unregistered file descriptors. Currently, this is only being used on LdPreloadedPosix::ld_preloaded_posix_close.
     */
